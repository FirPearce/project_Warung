        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-2">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white"><?= $pendapatan; ?></h2>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Pelanggan</h3>
                        <div class="d-inline-block">
                            <h2 class="text-white"><?= $totalpelanggan; ?></h2>
                            <p class="text-white mb-0"></p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        <h3 class="card-title text-white">Total Supplier</h3>
                        <div class="d-inline-block">
